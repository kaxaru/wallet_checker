...
from app.layer import Chain
from app.layer.caip2chaindata import CAIP2ChainData
...
def _chain_from_caip_2_data(
    ...
    **chain_kwargs: Any,
    ...
    target_rpc = None
    for rpc in chain_caip2_data.rpc_list:
    ...
    eip1559 = (
        "EIP1559" in {feature.name for feature in chain_caip2_data.features}
        if chain_caip2_data.features
        else False
    )
...
def get_chain(chain_id: int, **chain_kwargs: Any) -> Chain:
